...
def prepare_goodreads_data():
    ...
    try:
        ...
        print(f"\n Next steps:")
        print(f"   1. Update src/config.py line 17:")
        print(f"      RAW_DATA_PATH = os.path.join(RAW_DATA_DIR, 'books_prepared.csv')")
        print(f"   2. Run: python src/data_processor.py")
        print(f"   3. Run: python src/embedder.py")
