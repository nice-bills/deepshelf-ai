...
class TestIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sample_data = {
            ...
            'description': ['A story of American and British expatriates in Paris.', 'A love story during World War I.', 'An American in the Spanish Civil War.', 'An old fisherman struggles with a giant marlin.'],
